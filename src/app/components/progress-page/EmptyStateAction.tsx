        ...
        <div className="w-screen h-screen flex justify-center items-center">
            <div className="sm:max-w-[470px] w-full flex flex-col justify-center sm:w-[470px]">
                ...
                <div className="flex w-full flex-col justify-center gap-[15px] text-center">
                    <div className="font-[500] text-[24px] text-black leading-[30.24px]">Here is your progress tracker!</div>
                    <div className="font-[500] text-[18px] leading-[22.68px] text-[#292d32]">Your progress will be displayed here when you get started</div>
                </div>
            </div>
        </div>
    );
