...
const StatisticsCard = () => {
  return (
       <div className="relative cursor-pointer p-4 bg-[#bbdefb] rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105 hover:shadow-xl lh-[300px]">
