...
const StatisticsCard = () => {
  return (
       <div className="lg:w-[900px] relative cursor-pointer p-4 bg-[#bbdefb] rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105 hover:shadow-xl h-[300px]">
